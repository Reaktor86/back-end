...
<script>
    ...
    document.querySelector("form button").addEventListener("click", function (e){
        ...
        fetch("pract4-finance.php", {
            body: json, method: 'POST', headers: {
            ...
            .then((response) => {
                ...
                td.innerHTML = "" + response.date;
                root.append(td);

                td = document.createElement("td");
                td.innerHTML = response.money;
                root.append(td);

                td = document.createElement("td");
                td.innerHTML = response.comm;
                root.append(td);
            })
    })
</script>
